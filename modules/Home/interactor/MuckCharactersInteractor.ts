...
export class MuckCharacatersInteractor implements CharactersInteractorInterface {
  getCharactaters(params: GetCharacterParams): Promise<CharacterResponseEntity> {
    const data = this.mucks;
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        ...
        if (success) {
          ...
          reject(new Error('Muck error'));
        }
      }, 1000);
    });
  }

  private mucks: CharacterResponseEntity = {
    info: {
      count: 826,
      pages: 42,
